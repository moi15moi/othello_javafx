...
public class CaseAjustable extends CanvasAjustable {
	...
	private void dessinerFond(Case laCase) {
		...
		pinceau.fillArc(laCase.caseHautGaucheX, laCase.caseHautGaucheY, laCase.tailleCase, laCase.tailleCase, 0, 360,
				ArcType.ROUND);
	}
	...
	private void dessinerContour(Case laCase) {
		...
		pinceau.strokeArc(laCase.caseHautGaucheX, laCase.caseHautGaucheY, laCase.tailleCase, laCase.tailleCase, 0, 360,
				ArcType.OPEN);
	}
